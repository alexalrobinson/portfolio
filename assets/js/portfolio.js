...
$("#themeChange").click(()=>{
    ...
    if(factor === 0){
        $('link[rel=stylesheet][href~="../css/light.css"]').attr('disabled', 'true');
        $('link[rel=stylesheet][href~="../css/color.css"]').attr('disabled', 'true');
        $('link[rel=stylesheet][href~="../css/dark.css"]').removeAttr('disabled');
        $('#name').html(`<i class="fas fa-moon"></i>`);
    }
    else if(factor === 1){
        $('link[rel=stylesheet][href~="../css/dark.css"]').attr('disabled', 'true');
        $('link[rel=stylesheet][href~="../css/light.css"]').attr('disabled', 'true');
        $('link[rel=stylesheet][href~="../css/color.css"]').removeAttr('disabled');
        $('#name').html(`<i class="fas fa-palette"></i>`);
    }
    else{
        $('link[rel=stylesheet][href~="../css/dark.css"]').attr('disabled', 'true');
        $('link[rel=stylesheet][href~="../css/color.css"]').attr('disabled', 'true');
        $('link[rel=stylesheet][href~="../css/light.css"]').removeAttr('disabled');
